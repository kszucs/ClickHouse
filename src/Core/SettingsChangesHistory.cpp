...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"allow_experimental_opendal_table_function", false, false, "New setting to enable the experimental `opendal` table function."},
            {"opendal_truncate_on_insert", false, false, "New setting for the `opendal` table function."},
            {"opendal_create_new_file_on_insert", false, false, "New setting for the `opendal` table function."},
            {"opendal_skip_empty_files", false, false, "New setting for the `opendal` table function."},
            {"schema_inference_use_cache_for_opendal", true, true, "New setting for the `opendal` table function."},
        });
